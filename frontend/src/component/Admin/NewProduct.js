...
import AccountTreeIcon from '@mui/icons-material/Spellcheck';
import DescriptionIcon from '@mui/icons-material/Spellcheck';
import StorageIcon from '@mui/icons-material/Spellcheck';
import SpellcheckIcon from '@mui/icons-material/Spellcheck';
import AttachMoneyIcon from '@mui/icons-material/Spellcheck';
...
const NewProduct = ({ history }) => {
  ...
  const createProductSubmitHandler = (e) => {
    ...
    dispatch(createProduct(myForm));
       ...
       alert.success("Please add image");
    }
  };
        ...
        <div className="newProductContainer">
          ...
          >
            ...
            <div>              
              <input
                type="text"
                placeholder="Shipping charge threshold."
                required
