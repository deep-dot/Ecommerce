...
exports.registerUser = catchAsyncErrors(async (req, res, next) => {
    ...
    //   crop: "scale",
    // });
    // console.log(myCloud); // Check the output
...
exports.forgotPassword = catchAsyncErrors(async (req, res, next) => { 
  ...
  // console.log('forgot password backend ====', req.body);
  if (!user) {
...
const resetPasswordUrl = `${url}/password/reset/${resetToken}`;
  ...
  //console.log('forgot password backend ====', req.body, resetToken, resetPasswordUrl, message);
  try {
    await sendEmail({
      email: user.email,
